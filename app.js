...
$('exportJson').addEventListener('click',()=>download('macro_regime_scanner_public_source_data_contract_v0_47.json',JSON.stringify({notice:'Public-source data contract. v0.47 preserves v0.46 research infrastructure and tightens the asset universe to U.S.-centered, honestly supported coverage. Non-USD FX crosses are excluded until direct non-U.S. source lanes exist.',assets:ASSETS,source_status:SOURCE_STATUS,release_calendar:RELEASE_CALENDAR,release_results:RELEASE_RESULTS,source_quality:SOURCE_QUALITY,validation_summary:VALIDATION_SUMMARY,regime_bridge:REGIME_BRIDGE},null,2)));
