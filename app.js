...
$('exportJson').addEventListener('click',()=>download('macro_regime_scanner_public_source_data_contract_v0_48.json',JSON.stringify({notice:'Public-source data contract. v0.48 is the distribution-ready baseline: U.S.-centered, raw-score, price-free macro pressure research data with unsupported non-USD crosses excluded until direct non-U.S. source lanes exist.',assets:ASSETS,source_status:SOURCE_STATUS,release_calendar:RELEASE_CALENDAR,release_results:RELEASE_RESULTS,source_quality:SOURCE_QUALITY,validation_summary:VALIDATION_SUMMARY,regime_bridge:REGIME_BRIDGE},null,2)));
