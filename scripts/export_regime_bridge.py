...
def main():
    ...
    payload={'version':'v0.48-regime-bridge-distribution-ready-baseline','generatedAt':now,'intendedConsumers':['TradeStream','Capital Trace','Pathwise'],'warning':'Evidence labels are research context, not trade signals. v0.48 keeps the U.S.-centered asset universe and excludes unsupported non-USD FX crosses until direct non-U.S. source lanes exist.', 'regimes':rows}
