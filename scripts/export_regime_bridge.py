...
def main():
    ...
    payload={'version':'v0.50-macro-quad-snapshot','generatedAt':now,'intendedConsumers':['TradeStream','Capital Trace','Pathwise'],'warning':'Evidence labels are research context, not trade signals. v0.50 keeps the U.S.-centered asset universe and excludes unsupported non-USD FX crosses until direct non-U.S. source lanes exist, and adds the no-price Growth / Inflation Pressure Map for macro context.', 'regimes':rows}
